                    ...
                    <div className='col-12 col-sm-12 col-md-10 '>
                        ...
                        <div className='row mt-2 pl-2'>
                            ...
                            {open && <Popup setOpen={setOpen} />}
                                ...
                                {currentDashboardPage !== DashboardPages.DashboardOverview && currentDashboardPage !== DashboardPages.FloorBoard && <Reports tableRequest={currentDashboardPage}></Reports>}
                                {currentDashboardPage === DashboardPages.FloorBoard && <Importer open={open} setOpen={setOpen}></Importer>}
